...
import nunes.luciano.domain.PagamentoComBoleto;
import nunes.luciano.domain.PagamentoComCartao;
import nunes.luciano.domain.Pedido;
import nunes.luciano.domain.Produto;
import nunes.luciano.enums.EstadoPagamento;
...
import nunes.luciano.repositories.ItemPedidoRepository;
import nunes.luciano.repositories.PagamentoRepository;
import nunes.luciano.repositories.PedidoRepository;
import nunes.luciano.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Da silva Costa", "lucianonunesfonseca@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA,bCryptPasswordEncoder.encode("12345"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Luciano Nunes", "lucianonunesfonseca@gmail.com", "31628382740", TipoCliente.PESSOAFISICA,bCryptPasswordEncoder.encode("12345"));
		cli2.getTelefones().addAll(Arrays.asList("994785691", "33752469"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Goias", "105", "Sala 80", "Centro", "33752469", cli2, c2);
